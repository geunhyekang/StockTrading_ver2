...
public class TransactionService {
    ...
    private final UserRepository userRepository;         // 거래하면 잔액을 바꿔야 하니까
    private final StockRepository stockRepository;       // 현재가를 조회해야 하니까
    private final PortfolioService portfolioService;     // STEP 3-1에서 만든 부품!
// 생성자는 안 만들어도 됨 — 클래스 위의 @RequiredArgsConstructor(Lombok)가
// final 필드들의 생성자를 자동 생성 → 스프링이 그 생성자로 주입(DI)해 줌
